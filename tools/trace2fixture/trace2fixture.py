...
Then move the file to shared/src/commonTest/kotlin/com/rndeveloper/paparcar/domain/coordinator/replay/
...
def main() -> None:
    ...
    t0 = rows[0][0]
    print("package com.rndeveloper.paparcar.domain.coordinator.replay\n")
