    ...
    Scaffold(containerColor = cs.surface) { pad ->
        Column(
            ...
            SwitchRow("Conduciendo (puck en movimiento en Home)", driving) { on ->
                ...
                if (on) {
                    runtime.setTrip(
                        com.rndeveloper.paparcar.domain.detection.TripContext(
                            // Origin at the driving-sim route start (El Puerto, Av. de Valencia). [ROUTE-SNAP-001]
                            departurePoint = com.rndeveloper.paparcar.domain.model.GpsPoint(36.6068, -6.2270, 8.5f, 0L, 0f),
            ...
            SwitchRow(
                ...
                candidate == com.rndeveloper.paparcar.domain.detection.DetectionPhase.Candidate,
            ) { on ->
                runtime.setPhase(
                    if (on) com.rndeveloper.paparcar.domain.detection.DetectionPhase.Candidate
                    else com.rndeveloper.paparcar.domain.detection.DetectionPhase.Driving
                )
            }
