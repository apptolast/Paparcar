...
-keep,includedescriptorclasses class com.rndeveloper.paparcar.**$$serializer { *; }
-keepclassmembers class com.rndeveloper.paparcar.** {
    *** Companion;
}
-keepclasseswithmembers class com.rndeveloper.paparcar.** {
...
# ─────────────────────────────────────────────────────────────────────────────
-keep class com.rndeveloper.paparcar.di.** { *; }
-keep class com.rndeveloper.paparcar.data.datasource.remote.FirebaseDataSourceImpl { *; }
-keepnames class kotlin.coroutines.Continuation

# ─────────────────────────────────────────────────────────────────────────────
# Room — keep entities, DAOs, and the generated `_Impl` classes.
# ─────────────────────────────────────────────────────────────────────────────
-keep class com.rndeveloper.paparcar.data.datasource.local.room.** { *; }
...
# ─────────────────────────────────────────────────────────────────────────────
-keep class com.rndeveloper.paparcar.data.datasource.remote.dto.** { *; }
-keep class com.rndeveloper.paparcar.domain.model.** { *; }
