...
import com.rndeveloper.paparcar.domain.detection.fence.GeofenceRegistrationFailure
...
sealed interface DetectionEvent {
    ...
    data class Trigger(
        ...
        override val timestampMs: Long,
        val trigger: String,
        val disposition: com.rndeveloper.paparcar.domain.detection.sentry.TriggerDisposition,
    ...
    data class Hold(
        override val sessionId: String,
        override val timestampMs: Long,
        val action: com.rndeveloper.paparcar.domain.detection.HoldAction,
