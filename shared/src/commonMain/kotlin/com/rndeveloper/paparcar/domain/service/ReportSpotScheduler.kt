...
interface ReportSpotScheduler {
    ...
    fun enqueueReportSpot(
         ...
         *  (see [com.rndeveloper.paparcar.domain.detection.DepartureProof]). Publishes at the same
         *  speed — freshness is the whole value of a spot — but with
         *  [com.rndeveloper.paparcar.domain.model.SpotTtlPolicy.PROVISIONAL_SPOT_TTL_MS] so a wrong
