 ...
 * ([com.rndeveloper.paparcar.domain.diagnostics.DetectionEventLogger] /
 * [com.rndeveloper.paparcar.domain.diagnostics.UiLocationLogger]), but that data has an owner, and
