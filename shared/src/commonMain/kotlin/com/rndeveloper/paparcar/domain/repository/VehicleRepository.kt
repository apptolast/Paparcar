...
interface VehicleRepository : UserScopedRepository, RemoteSyncable {
     ...
     * [com.rndeveloper.paparcar.domain.usecase.parking.ConfirmParkingUseCase] that already
     ...
     * address before reaching [com.rndeveloper.paparcar.domain.usecase.parking.ConfirmParkingUseCase]).
