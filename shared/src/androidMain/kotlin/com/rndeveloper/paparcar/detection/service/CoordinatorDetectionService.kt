package com.rndeveloper.paparcar.detection.service
...
import com.rndeveloper.paparcar.domain.detection.sentry.CheapWakeVerdict
import com.rndeveloper.paparcar.domain.detection.sentry.cheapWakeVerdict
import com.rndeveloper.paparcar.domain.detection.sentry.isInsideAnyOwnedFence
import com.rndeveloper.paparcar.domain.detection.physics.SessionOutcome
import com.rndeveloper.paparcar.domain.detection.sentry.mayTriageSentryWake
import com.rndeveloper.paparcar.domain.detection.sentry.userStopQuietPeriodRemainingMs
...
import com.rndeveloper.paparcar.domain.detection.sentry.PostDetectionLifecycle
...
import com.rndeveloper.paparcar.domain.detection.sentry.nextSentryWakeAbortStreak
import com.rndeveloper.paparcar.domain.detection.sentry.resolvePostDetectionLifecycle
import com.rndeveloper.paparcar.domain.detection.sentry.sentryWakeRearmCooldownMs
...
import com.rndeveloper.paparcar.domain.usecase.detection.ArEnterDecision
...
class CoordinatorDetectionService : LifecycleService() {
    ...
    private val drivingRouteStore: com.rndeveloper.paparcar.domain.detection.ports.DrivingRouteStore by inject()
    private val locationDataSource: com.rndeveloper.paparcar.domain.location.LocationDataSource by inject() // [ROUTE-PASSIVE-FILL-001]
            ...
            ParkingStrategy.COORDINATOR -> {
                ...
                if (detectionJob?.isActive == true) {
                    ...
                    val supersede = newSession != null && radius != null &&
                        com.rndeveloper.paparcar.domain.detection.sentry.shouldSupersedeRunningSession(
    ...
    private fun enterSentry(reason: String, geofenceId: String?) {
        ...
        if (isDebugBuild) notificationPort.showDebug("Modo CENTINELA: coche aparcado y detección terminada → quedo residente con GPS apagado, esperando; cuando el coche se mueva verás 'Detección ARRANCADA'")
    ...
    private suspend fun startParkingDetection(
        ...
        com.rndeveloper.paparcar.detection.PendingDetectionStore.arm(applicationContext, armId, armedAt, trigger.name)
        detectionJob = lifecycleScope.launch {
            ...
            val heartbeat = launch {
                launch {
                    detectionRuntime.phase.collect { phase ->
                        if (phase == com.rndeveloper.paparcar.domain.detection.DetectionPhase.Candidate) {
                            com.rndeveloper.paparcar.detection.PendingDetectionStore.heartbeat(
            ...
            try {
                ...
                com.rndeveloper.paparcar.detection.PendingDetectionStore.clear(applicationContext, armId)
    ...
    companion object {
        ...
        const val ACTION_START_TRACKING = "com.rndeveloper.paparcar.ACTION_START_TRACKING"
        const val ACTION_STOP_TRACKING = "com.rndeveloper.paparcar.ACTION_STOP_TRACKING"
        ...
        const val ACTION_USER_STOP = "com.rndeveloper.paparcar.ACTION_USER_STOP"
        ...
        const val ACTION_SENTRY_WAKE = "com.rndeveloper.paparcar.ACTION_SENTRY_WAKE"
        ...
        const val ACTION_RESUME_SENTRY = "com.rndeveloper.paparcar.ACTION_RESUME_SENTRY"
        const val EXTRA_RESUME_SOURCE = "com.rndeveloper.paparcar.EXTRA_RESUME_SOURCE"
        ...
        const val EXTRA_TRIAGE_ONLY = "com.rndeveloper.paparcar.EXTRA_TRIAGE_ONLY"
        ...
        const val ACTION_BT_OVERRIDE = "com.rndeveloper.paparcar.ACTION_BT_OVERRIDE"
        const val EXTRA_BT_OVERRIDE_REASON = "com.rndeveloper.paparcar.EXTRA_BT_OVERRIDE_REASON"
        ...
        const val ACTION_GEOFENCE_EXIT = "com.rndeveloper.paparcar.ACTION_GEOFENCE_EXIT"
        ...
        const val ACTION_AR_TRANSITION = "com.rndeveloper.paparcar.ACTION_AR_TRANSITION"
        ...
        const val ACTION_PARKING_CONFIRMED = "com.rndeveloper.paparcar.ACTION_PARKING_CONFIRMED"
        const val ACTION_PARKING_DENIED = "com.rndeveloper.paparcar.ACTION_PARKING_DENIED"
        // [REFACTOR-300] Post-save confirm (state B): the parking has been saved; user is
        // acknowledging or reverting.
        const val ACTION_PARKING_ACK = "com.rndeveloper.paparcar.ACTION_PARKING_ACK"
        const val ACTION_PARKING_REVERT = "com.rndeveloper.paparcar.ACTION_PARKING_REVERT"
        const val EXTRA_PARKING_ID = "com.rndeveloper.paparcar.EXTRA_PARKING_ID"
        // [DET-AR-REARM-001] Watchdog "still parked? → I've left" → release the spot for the geofence.
        const val ACTION_DEPARTURE_CONFIRMED = "com.rndeveloper.paparcar.ACTION_DEPARTURE_CONFIRMED"
        const val EXTRA_GEOFENCE_ID = "com.rndeveloper.paparcar.EXTRA_GEOFENCE_ID"
