...
**Estado:** 🔵 Abierto, sin código · rama `feature/IOS-SOCIAL-LOGIN-001-google-apple` · worktree
`../Paparcar-ios-social` · abierto el 14-08-2026 tras [DEPS-BASELOGIN-110](deps-baselogin-110.md)
