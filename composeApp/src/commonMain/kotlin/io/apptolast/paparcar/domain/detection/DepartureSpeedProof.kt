 ...
 *
 * Shared by two verdicts (the arm's [io.apptolast.paparcar.domain.usecase.parking
 * .VerifyDepartureEvidenceUseCase] and the worker's
 * [io.apptolast.paparcar.domain.usecase.parking.DetectParkingDepartureUseCase]), so it is a pure
